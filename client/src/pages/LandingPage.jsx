    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-black text-white">
      <div className="container mx-auto px-4">
        ...
        <div className="py-20 md:py-32 text-center">
          ...
          >
            Explore ideas, share thoughts, and learn together in a community of curious minds.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <section className="py-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Discover Your Interests</h2>
            <p className="text-gray-400">Explore content across various categories</p>
          </div>
        ...
        <section className="py-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Why Choose Muse?</h2>
            <p className="text-gray-400">Experience the difference with our unique features</p>
          </div>
        ...
        <section className="py-20 text-center">
          <div className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-2xl p-12 border border-white/10">
            ...
            <p className="text-xl text-gray-300 mb-8">Join thousands of curious minds exploring new ideas every day.</p>
            <Link 
              to="/signup"
